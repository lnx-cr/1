...
#include "uart_bsp.h"
float POS2,POS1,POS3,POS4,POS5,POS6,POS7,POS8;
float zero_1=0.5,zero_2=24,zero_3=21,zero_4=1.2,zero_5=-17.5,zero_6=3,zero_7=4.8,zero_8=-18.11;
float hui_1=5,hui_2=4.5,hui_3=4,hui_4=3.2,hui_5=1,hui_6=3.5,hui_7=2.8,hui_8=2;
...
int main(void)
{
  ...
  MX_TIM2_Init();
  /* USER CODE BEGIN 2 */
	HAL_UARTEx_ReceiveToIdle_IT(&huart5, rx_buff, BUFF_SIZE);
